...
{
    /// <summary>
    /// Core game logic model managing the board state, cell movements, and game rules.
    /// Handles all game state calculations and validates player/computer moves.
    /// </summary>
    public class GameModel
    {
        ...
        /// <summary>
        /// Executes an action for each position within a rectangular area on the board.
        /// </summary>
        ...
        /// <summary>
        /// Gets the GameObject at the specified board position.
        /// </summary>
        ...
        /// <summary>
        /// Checks if a candidate cell at the given position matches the requested box type.
        /// </summary>
        ...
        /// <summary>
        /// Checks if there are no more cells of the specified type on the board.
        /// </summary>
        ...
        /// <summary>
        /// Moves or clones a cell to a destination, then contaminates nearby cells.
        /// Returns the animation steps to execute.
        /// </summary>
        ...
        /// <summary>
        /// Returns all free boxes within a specified rectangular area.
        /// </summary>
        ...
        /// <summary>
        /// Returns all playable cell positions for the specified box value.
        /// A playable cell must have at least one empty spot within MaxDistanceMove.
        /// </summary>
